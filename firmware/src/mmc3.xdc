...
set_property IOSTANDARD LVCMOS25 [get_ports {PMOD[7]}]
set_property IOSTANDARD LVCMOS25 [get_ports {PMOD[6]}]
set_property IOSTANDARD LVCMOS25 [get_ports {PMOD[5]}]
set_property IOSTANDARD LVCMOS25 [get_ports {PMOD[4]}]
set_property IOSTANDARD LVCMOS25 [get_ports {PMOD[3]}]
set_property IOSTANDARD LVCMOS25 [get_ports {PMOD[2]}]
set_property IOSTANDARD LVCMOS25 [get_ports {PMOD[1]}]
set_property IOSTANDARD LVCMOS25 [get_ports {PMOD[0]}]
set_property PACKAGE_PIN AC23 [get_ports {PMOD[7]}]
set_property PACKAGE_PIN AA25 [get_ports {PMOD[6]}]
set_property PACKAGE_PIN AC24 [get_ports {PMOD[5]}]
set_property PACKAGE_PIN AB25 [get_ports {PMOD[4]}]
set_property PACKAGE_PIN W25 [get_ports {PMOD[3]}]
set_property PACKAGE_PIN V24 [get_ports {PMOD[2]}]
set_property PACKAGE_PIN W26 [get_ports {PMOD[1]}]
set_property PACKAGE_PIN V26 [get_ports {PMOD[0]}]
set_property PULLDOWN true [get_ports {PMOD[7]}]
set_property PULLDOWN true [get_ports {PMOD[6]}]
set_property PULLDOWN true [get_ports {PMOD[5]}]
...
set_property DRIVE 16 [get_ports {PMOD[7]}]
set_property DRIVE 16 [get_ports {PMOD[6]}]
set_property DRIVE 16 [get_ports {PMOD[5]}]
set_property DRIVE 16 [get_ports {PMOD[4]}]
set_property DRIVE 16 [get_ports {PMOD[3]}]
set_property DRIVE 16 [get_ports {PMOD[2]}]
set_property DRIVE 16 [get_ports {PMOD[1]}]
set_property DRIVE 16 [get_ports {PMOD[0]}]
